...
- `@deepseek-ai/dsh-tui`（[`packages/bundle/tui/src/index.ts`](../packages/bundle/tui/src/index.ts)）
- `@deepseek-ai/dsh-tui-demo`（[`packages/examples/tui-demo/src/index.ts`](../packages/examples/tui-demo/src/index.ts)）
